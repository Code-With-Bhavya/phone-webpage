...
import Specifications from "../components/SpecificationsUI/Specifications"
import NewsGallery from "../components/NewsGallery/newsgallery"
import PhoneComparisonSlider from "../components/PopularComparison/popularcomparison"
    ...
    <>
      <div className="w-screen relative">
        ...
        <main className="bg-[#f2f7ff] w-full pt-[10px] px-[10px] flex flex-col items-center">
          ...
          <div className="w-full lg:w-[80%] mt-[10px] h-[fit-content] bg-white relative border border-[#e6e6ef] rounded-[10px]">
            <div className="w-full h-fit bg-gradient-to-t from-[#e6eafa] to-white p-[14px] rounded-t-[10px]">
              <NewsGallery />
              </div>
          </div>
